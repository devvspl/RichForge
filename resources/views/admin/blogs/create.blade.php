                ...
                <div class="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 shadow-sm space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea id="article-content-editor"
                                  ...
                                  class="w-full min-h-[350px] px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-xs font-mono text-[#1a1a2e] focus:ring-2 focus:ring-fuchsia-500">{{ old('content') }}</textarea>
